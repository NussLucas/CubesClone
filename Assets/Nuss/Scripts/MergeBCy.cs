...
namespace Nuss
{
    public class MergeBCyCollision : MonoBehaviour
    {
        ...
        private void OnCollisionEnter(Collision collision)
        {
            ...
            if ((gameObject.CompareTag("Cyclinder") && collision.gameObject.CompareTag("Sphere")) ||
                 (gameObject.CompareTag("Sphere") && collision.gameObject.CompareTag("Cyclinder")))
            {
