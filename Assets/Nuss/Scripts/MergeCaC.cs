...
namespace Nuss
{
    ...
    public class MergeCaCCollision : MonoBehaviour
    {
        ...
        private void OnCollisionEnter(Collision collision)
        {
            ...
            if ((gameObject.CompareTag("Capsule") && collision.gameObject.CompareTag("Cube")) ||
                 (gameObject.CompareTag("Cube") && collision.gameObject.CompareTag("Capsule")))
            {
