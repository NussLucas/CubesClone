...
namespace Nuss
{
    public class MergeCaBCollision : MonoBehaviour
    {
        ...
        private void OnCollisionEnter(Collision collision)
        {
            ...
            if ((gameObject.CompareTag("Capsule") && collision.gameObject.CompareTag("Sphere")) ||
                 (gameObject.CompareTag("Sphere") && collision.gameObject.CompareTag("Capsule")))
            {
                ...
                if (gameObject.GetInstanceID() < collision.gameObject.GetInstanceID())
                {
                    ...
                    newCube.transform.localScale = newSize * 2;
