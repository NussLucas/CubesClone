...
namespace Nuss
{
    public class MergeCSCollision : MonoBehaviour
    {
        ...
        private void OnCollisionEnter(Collision collision)
        {
            ...
            if ((gameObject.CompareTag("Cube") && collision.gameObject.CompareTag("Sphere")) ||
                 (gameObject.CompareTag("Sphere") && collision.gameObject.CompareTag("Cube")))
            {
